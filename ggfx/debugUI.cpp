...
void DebugUI::createDebugUI(Window* window)
{
    ...
    style.Colors[ImGuiCol_TitleBg] = ImVec4(0.45f, 0.45f, 0.45f, 0.45f);
    style.Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.38f, 0.38f, 0.38f, 0.20f);
    style.Colors[ImGuiCol_TitleBgActive] = ImVec4(0.52f, 0.52f, 0.52f, 0.55f);
    style.Colors[ImGuiCol_MenuBarBg] = ImVec4(0.55f, 0.55f, 0.55f, 0.80f);
    ...
    style.Colors[ImGuiCol_Button] = ImVec4(0.67f, 0.67f, 0.67f, 0.60f);
    style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.67f, 0.67f, 0.67f, 1.00f);
    ...
    style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.90f, 0.90f, 0.90f, 0.80f);
